...
// another method on the searching when youre already on singleproduct page
  ...
  function AddCart(){
    fetch("http://localhost:8000/product/cart",{
      ...
      body:JSON.stringify({user:userID,product:single._id,quantity:quantity})
    })
    .then(function(response){
      return response.json()
    })
      ...
      <div className="single">
        ...
        <div className="single_details">
          ...
          <div className="single_buttons">
            <input type="number" defaultValue={1} placeholder="Enter quantity" onChange={function(event){
